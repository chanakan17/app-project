...
class GameData {
  ...
  static Future<void> saveScoreToDB() async {
    final url = Uri.parse('http://192.168.1.125/dataweb/save_score.php');
  ...
  static Future<void> loadTopScores() async {
    final url = Uri.parse(
      'http://192.168.1.125/dataweb/get_top_scores.php?user_id=$userId',
    );
  ...
  static Future<void> loadTopScores1() async {
    final url = Uri.parse('http://192.168.1.125/dataweb/get_topa_scores.php');
    final response = await http.get(url);
